...
import 'package:uvento_app_new/uvento/presentation/widgets/homepage_svg_icon_constants.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: RichText(
                  text: TextSpan(style: TextStyle(fontSize: ScreenUtil().setSp(20), color: Colors.white), children: [
                    TextSpan(text: "UVE"),
                    TextSpan(
                      text: "NTO",
                      style: TextStyle(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(backgroundImage: AssetImage('assets/images/ui_person.jpg'), radius: ScreenUtil().radius(30)),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    Expanded(
                      child: HorizontalCalendar(
                        ...
                        backgroundColor: Theme.of(context).backgroundColor,
                        selectedColor: Color(0xffFCCD00),
                        showMonth: false,
      ...
      //   //   borderRadius: BorderRadius.vertical(top: Radius.circular(ScreenUtil().radius(20))),
...
class PopularEventWidget extends StatelessWidget {
  ...
  const PopularEventWidget({Key? key, required this.title, required this.date, required this.location, required this.photoPath}) : super(key: key);
